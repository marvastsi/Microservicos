package com.marvastsi.pagamento.controller;
...
import com.marvastsi.pagamento.services.VendaService;
...
public class VendaController {
	...
	public VendaVO create(@RequestBody VendaVO vendaVO) {
		VendaVO savedVendaVo = vendaService.create(vendaVO);
		savedVendaVo.add(linkTo(methodOn(VendaController.class).findById(savedVendaVo.getId())).withSelfRel());
		return savedVendaVo;
	}
}
